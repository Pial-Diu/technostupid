              ...
              <div class="row px-4">
					...
					<div class="col-md-6" style="font-size: 14px;color:#5b5b5b;font-weight: bold;">
						<ul>
							...
							<li class="py-2"><i class="far fa-arrow-alt-circle-right" style="color:#ffc200"></i> Golang</li>
					...
					<div class="col-md-6" style="font-size: 14px;color:#5b5b5b;font-weight: bold;">
						<ul>
							...
							<li class="py-2"><i class="far fa-arrow-alt-circle-right" style="color:#ffc200"></i> Microservices</li>
